...
//                 </p>
//                 <div className="relative"> {/* Wrap input with relative for positioning the toggle */}
//                   <input
//                     style={{ fontFamily: 'var(--font-inter)' }}
//                     id="password"
//                     name="password"
//                     type={showPassword ? 'text' : 'password'} // Toggle between text and password
//                     className="w-full py-3.5 border rounded-xl px-5 text-[14px] text-gray-600 "
//                     placeholder="Enter your password"
//                   />
//                   <button
//                     type="button" // Prevent form submission
//                     onClick={togglePasswordVisibility}
//                     className="absolute right-3 top-3 text-gray-500" // Adjust position
        ...
        <form className="my-10" onSubmit={handleSubmit(onSubmit)}> {/* Add handleSubmit */}
          <div className="flex flex-col space-y-7">
              ...
              <section>
                <label htmlFor="firstName">
                  ...
                  <input
                    ...
                    placeholder="First Name"
                  />
                  {errors.firstName && <p className="text-red-500 text-sm">{errors.firstName.message}</p>} {/* Error message */}
                </label>
              </section>
              ...
              <section>
                <label htmlFor="lastName">
                  ...
                  <input
                    ...
                    placeholder="Last Name"
                  />
                  {errors.lastName && <p className="text-red-500 text-sm">{errors.lastName.message}</p>} {/* Error message */}
                </label>
              </section>
            </div>
            ...
            <label htmlFor="confirmPassword">
              ...
              {errors.confirmPassword && <p className="text-red-500 text-sm">{errors.confirmPassword.message}</p>} {/* Error message */}
            </label>
