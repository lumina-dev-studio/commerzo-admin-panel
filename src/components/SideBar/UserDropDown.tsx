...
const UserDropDown = () => {
  ...
  return (
    ...
    >
     ...
     <FiUser className=" text-[20px] font-semibold  hover:text-blue-500" />

<span className="flex-1 ml-3 text-left whitespace-nowrap text-[15px] font-semibold hover:text-blue-500" style={{ fontFamily: 'var(--font-inter)' }}>User</span>
    ...
    <ul className={`${dropdown ? "block" : "hidden"} py-2 space-y-2`}>
      ...
      <Link
        ...
        >
        <BsDiamond className=" text-[10px] opacity-50 mr-2" />     Sing Up
          </Link>
      </li>
