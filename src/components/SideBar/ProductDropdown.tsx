...
const ProductDropdown = () => {
  ...
  return (
    <li>
      ...
      >
        <FiShoppingCart className={`${dropDown === "product" && "text-blue-500"} text-[20px] font-semibold hover:text-blue-500`} />
        <span className={`${dropDown === "product" && "text-blue-500"} flex-1 ml-3 text-left whitespace-nowrap text-[15px] font-semibold hover:text-blue-500`} style={{ fontFamily: 'var(--font-inter)' }}>
          Product
        </span>
        <svg
      ...
      <ul className={`${dropDown === "product" ? "block" : "hidden"} py-2 space-y-2`}>
        <li>
          ...
          >
            <BsDiamond className={`${location==='/product/manageProduct'?"font-bold":" opacity-50"} text-[10px] mr-2`} /> Manage Product
          </Link>
        </li>
        <li>
          <Link
            ...
            style={{ fontFamily: 'var(--font-inter)' }}
          >
            <BsDiamond className={`${location==='/product/manageCategory'?"font-bold":" opacity-50"} text-[10px] mr-2`} /> Manage Category
          </Link>
        </li>
